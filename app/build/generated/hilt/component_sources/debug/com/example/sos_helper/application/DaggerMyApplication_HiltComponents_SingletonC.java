...
import com.example.sos_helper.activity.MainActivity;
import com.example.sos_helper.dagger.AppModule_GetFireStoreInstanceFactory;
import com.example.sos_helper.fragment.BaseFragment;
import com.example.sos_helper.fragment.BaseFragment_MembersInjector;
import com.example.sos_helper.fragment.LoginFragment;
import com.example.sos_helper.fragment.SignUpFragment;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends MyApplication_HiltComponents.FragmentC {
    ...
    private BaseFragment injectBaseFragment2(BaseFragment instance) {
      BaseFragment_MembersInjector.injectFbInstance(instance, singletonCImpl.getFireStoreInstanceProvider.get());
      return instance;
    }
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private dagger.internal.Provider<FirebaseFirestore> getFireStoreInstanceProvider;
    ...
    private void initialize() {
      this.getFireStoreInstanceProvider = DoubleCheck.provider(new SwitchingProvider<FirebaseFirestore>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements dagger.internal.Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) AppModule_GetFireStoreInstanceFactory.getFireStoreInstance();

 ...
 */
public abstract class Hilt_SignUpFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignUpFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectSignUpFragment(UnsafeCasts.<SignUpFragment>unsafeCast(this));
    }
  }
}
